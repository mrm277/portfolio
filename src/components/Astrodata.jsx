  ...
  <Navbar />    
    ...
    <div className="flex max-w-screen-xl mx-auto items-center">
      ...
      <div className="ml-14" style={{ width: "70%" }}>
        <h1 className="text-5xl text-white font-semibold"> Astrodata</h1>
        <div className="flex">
        ...
        <p className="text-xl text-white">
          ...
          like, play a game, and even win prizes.{" "}
          <a
            href="/astroprize"
          ...
          seen in AstroData. This is advantageous for the planetarium managers
          because it allows them to know where to invest. In addition, it is
          also possible to manage the works, the employees, and their roles, and
          validate the prizes for the participants. This project was developed
          in PHP. The database was created in MySQL. The front-end was developed
