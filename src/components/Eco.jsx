    ...
    <div className="flex max-w-screen-xl mx-auto items-center">
      ...
      <div className="ml-14" style={{ width: "70%" }}>
        ...
        <p className="text-xl text-white">
          ...
          goal is to allow children and teenagers to explore information about
          our planet and learn more about sustainability. The page includes a
          game section and a test, allowing users to test their knowledge.
        </p>
      </div>
    </div>
  </div>
